...
public class PortletSizeInLiferayFreeformLayoutApplication
    ...
    public void init() {
        ...
        ((LegacyVerticalLayout) mainWindow.getContent()).setMargin(false);
        ((LegacyVerticalLayout) mainWindow.getContent()).setSizeFull();
        // ((LegacyVerticalLayout) mainWindow.getContent()).setHeight("200px");
