...
public class MovingInvisibleField extends TestBase {
    ...
    protected void setup() {
        final LegacyVerticalLayout layout1 = new LegacyVerticalLayout();
        final LegacyVerticalLayout layout2 = new LegacyVerticalLayout();
    ...
    protected String getDescription() {
        return "Above and below the button is a LegacyVerticalLayout. Initially the first one contains two components: a visiable and an invisible TextField. Click the button to move the TextFields to the second layout, both should be moved but only the visible rendered.";
    }
